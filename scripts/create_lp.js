...
module.exports = async (done) => {
  try {
    ...
    console.log(
      "\nIn frontend/src/ponchy/lib/constants.js scroll to CHAIN_ID 97 (bsc_testnet)"
    );
    console.log(
      `Paste this ${pairAddress} LP token address into .env and supportedPools/lpAddresses`
    );
    console.log(
      `Paste this ${token1.address} Token1 address into supportedPools/tokenAddresses`
    );
    console.log(
      `Paste this ${token2.address} Token2 address into supportedPools/tokenAddresses`
    );
    console.log("\nAlso:");
